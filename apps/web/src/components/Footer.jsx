...
export default function Footer() {
  ...
  const social = {};
  if (links) links.forEach((l) => { social[l.platform] = l.url; });

  return (
    <footer className="footer">
      <div className="footer-inner">
        <div className="footer-brand">
          <span className="footer-logo">Aicha Hatim</span>
          <span className="footer-tagline">Coach professionnelle certifiée ICF &amp; CTI</span>
        </div>
      ...
      <div className="footer-bottom">
        <p>© {new Date().getFullYear()} Aicha Hatim · Tous droits réservés</p>
      </div>
    </footer>
  );
}